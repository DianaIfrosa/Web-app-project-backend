...
namespace proiectDAW.BLL.Helpers
{
    public class TokenHelper : ITokenHelper
    {
        ...
        public async Task<string> CreateAccessToken(User _User)
        {
            ...
            //ia fiecare rol din lista de roluri si creeaza un claim pe care il adauga in lista de claim-uri
            foreach (var role in roles) claims.Add(new Claim(ClaimTypes.Role, role));

            var secret = "123456789012345689999"; //hardcodat :(
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.Now.AddMinutes(10), //in 10 minute expira tokenul
